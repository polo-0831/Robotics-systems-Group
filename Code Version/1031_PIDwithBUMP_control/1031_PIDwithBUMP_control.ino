...
void loop()
{
  ...
  LeftCollide_thres = LeftBump_Min + (LeftBump_Max - LeftBump_Min) * 0.5;
  RightCollide_thres = RightBump_Min + (RightBump_Max - RightBump_Min) * 0.5;
  switch (state)
  {
