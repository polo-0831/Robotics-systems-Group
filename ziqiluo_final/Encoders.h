...
#define ENCODER_0_B_PIN 23 // right
#define ENCODER_1_A_PIN 26 // left
...
void setupEncoder1()
{
  ...
  // 11.1.7 Pin Change Mask Register 0 â€? PCMSK0
  PCMSK0 |= (1 << PCINT4);

  // Page 91, 11.1.6 Pin Change Interrupt Flag Register â€? PCIFR
